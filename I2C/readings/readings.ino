...
void loop()
{
        for (int i = 1; i<8; i++) {
                ...
                if (airSensor.dataAvailable())
                {
                        Serial.print("c"); Serial.print(i-1); Serial.println(airSensor.getCO2());
                        delay(100);
                        Serial.print("t"); Serial.print(i-1); Serial.println(airSensor.getTemperature(), 1);
                        delay(100);
                        Serial.print("h"); Serial.print(i-1); Serial.println(airSensor.getHumidity(), 1);
                        delay(150);
                }
        }
}
